...
public static class AspireAppSettings
{
    public static readonly Dictionary<string, string> Settings =
        new Dictionary<string, string>
        {
            ...
            ["OTEL_EXPORTER_OTLP_HEADERS"] = "x-otlp-api-key=378826003748c9c9c00145dd7a9aa226",
            ["OTEL_EXPORTER_OTLP_PROTOCOL"] = "grpc",
            ["OTEL_METRIC_EXPORT_INTERVAL"] = "1000",
            ["OTEL_METRICS_EXEMPLAR_FILTER"] = "trace_based",
            ["OTEL_RESOURCE_ATTRIBUTES"] = "service.instance.id=2qrn18acig",
            ["OTEL_SERVICE_NAME"] = "BaustellenAppMobileClient",
            ["OTEL_TRACES_SAMPLER"] = "always_on",
            ["services:BaustellenAppBackendApi:https:0"] = "https://localhost:7005",
